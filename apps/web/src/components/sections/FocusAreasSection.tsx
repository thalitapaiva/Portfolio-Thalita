  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-12 md:py-20">
        ...
        <div className="grid gap-3 sm:grid-cols-3 sm:gap-4" data-aos="zoom-y-out" role="tablist" aria-label={t.focus.title}>
          {AREA_ORDER.map((id) => {
        ...
        <div
          ...
          className="relative mt-5 overflow-hidden rounded-2xl border border-gray-800 bg-gray-950/80 p-5 sm:mt-6 sm:p-7"
          data-aos="zoom-y-out"
        >
          <div
            className={cn(
